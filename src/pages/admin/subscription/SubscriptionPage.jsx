  ...
  return (
    <div className="rounded-2xl border border-[color:rgba(0,0,128,0.14)] bg-[var(--white)] p-8">
      ...
      <p className="mt-2 text-sm text-[color:rgba(0,0,128,0.76)]">
        Manage subscriptions with customer details, invoice schedule, recurring plan, and lifecycle status.
      </p>
      ...
      <div className="mt-5">
        <input
          ...
          placeholder="Search by customer name, recurring or status"
      ...
      <div className="mt-6 overflow-x-auto rounded-xl border border-[color:rgba(0,0,128,0.12)]">
        <div className="min-w-[920px]">
          <div className="grid grid-cols-[1.2fr_1fr_1fr_1fr_136px] gap-4 bg-[rgba(0,0,128,0.04)] px-4 py-3 text-xs font-semibold uppercase tracking-[0.08em] text-[var(--navy)]">
              ...
              {subscriptions.map((subscription) => {
                ...
                return (
                  <div
                    ...
                    className="grid grid-cols-[1.2fr_1fr_1fr_1fr_136px] gap-4 px-4 py-4 text-sm text-[var(--navy)]"
                  >
        ...
        <div className="fixed inset-0 z-40 flex items-center justify-center bg-black/35 p-4">
          <div className="w-full max-w-md rounded-xl border border-[color:rgba(0,0,128,0.16)] bg-[var(--white)] p-6 shadow-[0_16px_40px_rgba(0,0,0,0.2)]">
            ...
            <p className="mt-1 text-xs text-[color:rgba(0,0,128,0.62)]">
              This action will permanently remove the subscription and related line details.
            </p>
