...
export function listCartItems() {
  return requestWithAuth('/api/v1/cart/items', {
    method: 'GET',
  })
}
...
export function updateCartItemQuantity(cartItemId, payload) {
  return requestWithAuth(`/api/v1/cart/items/${encodeURIComponent(cartItemId)}`, {
    method: 'PATCH',
    payload,
  })
}
