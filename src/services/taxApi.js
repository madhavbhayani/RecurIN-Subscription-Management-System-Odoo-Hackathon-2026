...
export function listTaxes(search = '', page) {
  return requestWithAuth('/api/v1/admin/taxes', {
    method: 'GET',
...
export function getTaxById(taxId) {
  return requestWithAuth(`/api/v1/admin/taxes/${encodeURIComponent(taxId)}`, {
    method: 'GET',
  })
}

export function updateTax(taxId, payload) {
  return requestWithAuth(`/api/v1/admin/taxes/${encodeURIComponent(taxId)}`, {
    method: 'PUT',
    payload,
  })
