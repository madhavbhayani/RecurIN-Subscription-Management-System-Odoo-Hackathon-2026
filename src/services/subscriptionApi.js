...
export function listSubscriptions(search = '', page) {
  return requestWithAuth('/api/v1/admin/subscriptions', {
    method: 'GET',
...
export function getSubscriptionById(subscriptionId) {
  return requestWithAuth(`/api/v1/admin/subscriptions/${encodeURIComponent(subscriptionId)}`, {
    method: 'GET',
  })
}
