...
export function getRecurringPlanById(recurringPlanId) {
  return requestWithAuth(`/api/v1/admin/recurring-plans/${encodeURIComponent(recurringPlanId)}`, {
    method: 'GET',
  })
}

export function updateRecurringPlan(recurringPlanId, payload) {
  return requestWithAuth(`/api/v1/admin/recurring-plans/${encodeURIComponent(recurringPlanId)}`, {
    method: 'PUT',
    payload,
  })
...
export function deleteRecurringPlan(recurringPlanId) {
  return requestWithAuth(`/api/v1/admin/recurring-plans/${encodeURIComponent(recurringPlanId)}`, {
    method: 'DELETE',
  })
}
