...
export function listDiscounts(search = '', page) {
  return requestWithAuth('/api/v1/admin/discounts', {
    method: 'GET',
...
export function getDiscountById(discountId) {
  return requestWithAuth(`/api/v1/admin/discounts/${encodeURIComponent(discountId)}`, {
    method: 'GET',
  })
}

export function updateDiscount(discountId, payload) {
  return requestWithAuth(`/api/v1/admin/discounts/${encodeURIComponent(discountId)}`, {
    method: 'PUT',
    payload,
  })
